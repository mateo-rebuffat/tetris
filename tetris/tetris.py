...
class Tetris(object):
    ...
    def run(self):
        while True:  # Boucle extérieure pour relancer le jeu
            ...
            if self.game_over:
                ...
                # Demander au joueur s'il veut relancer le jeu
                replay = input("Voulez-vous relancer le jeu ? (o/n): ").lower()
                if replay != 'o':
                    break  # Sortir de la boucle extérieure si le joueur ne veut pas rejouer
            ...
            self.score = 0
            # Réinitialiser d'autres attributs ou réinitialiser le plateau, etc.
    ...
    def save_score(self):
        ...
        with open('scores.txt', 'a') as file:
            # Écrire le nom du joueur et son score dans le fichier
...
while game_running:
    ...
    # Launch the Tetris game
        print("Lancement du jeu Tetris...")
        main()  # Ajouter les parenthèses pour appeler la fonction


        

    elif choice == 2:
        # View the content of the scores.txt file
        print("Scores des autres joueurs : ")
